...
func newEphemeralCommand() *cobra.Command {
	...
	f.StringVar(&o.file, "file", "", "")
	selectionFlags(f, &o.tags, &o.toolchain)
	f.StringVar(&o.replacement, "replacement", "", "")
	f.StringVar(&o.batch, "batch", "", "")
	f.StringVar(&o.testPkg, "test-pkg", "", "")
	f.StringVar(&o.runPat, "run", "", "")
	...
	f.IntVar(&o.runs, "runs", 1, "")
	f.StringVar(&o.attest, "attest", "", "")
	f.StringVar(&o.findingsFile, "findings", defaultFindings, "")
	f.BoolVar(&o.reattest, "reattest", false, "")
	return knobbedFlags(cmd, "ephemeral")
}

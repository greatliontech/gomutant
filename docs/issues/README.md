...
| [observation-union-memory](observation-union-memory.md) | Per-symbol observation retention (candidates × observation size) OOMed the host at 25.9 GB anon-rss | The union folds incrementally as mutants complete, bounding memory to union + in-flight |

...
| [campaign-baseline-needs-scoped-oracles](campaign-baseline-needs-scoped-oracles.md) | suite-scale oracles: single-target campaigns landed and measured (12h43m worst case); chunk-scale extrapolates to weeks — decomposition vs survivor-oracle narrowing vs idle-window acceptance | user decision |

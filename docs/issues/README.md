...
| [false-survivors-despite-killing-oracle](false-survivors-despite-killing-oracle.md) | campaign records survivors a killing package oracle refutes (tugboat 2026-08-19) | train chunk 103 |
...
| [growth-serve-misses-modified-oracle-bodies](growth-serve-misses-modified-oracle-bodies.md) | VERDICT INTEGRITY: strengthen-in-place oracle edit leaves a false survivor served | train chunk 103 |
...
| [findings-doc-unbounded-growth](findings-doc-unbounded-growth.md) | repo-layer findings.json at 70 MB after one campaign; nothing bounds or compacts it | train chunk 110 |
| [findings-inspection-cost](findings-inspection-cost.md) | inspection without re-judging freshness; summary reads O(targets); 28MB/85-target audit | train chunk 110 |
| [library-suite-exceeds-default-test-timeout](library-suite-exceeds-default-test-timeout.md) | root-package suite ~16m on go1.27; plain go test panics verdictless at the 10m default | folds into train chunk 107 (CI) |
